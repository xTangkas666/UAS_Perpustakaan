          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            ...
            <div class="dropdown-menu dropdown-menu-right">
              ...
              <form method="POST" action="{{ route('logout') }}">
                ...
                <x-dropdown-link :href="route('logout')" class="dropdown-item has-icon" onclick="event.preventDefault();
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            @include('dashboard.sidebarAdmin')
            @endif
            @if(auth()->user()->level == 'Penulis')
            @include('dashboard.sidebarPenulis')
            @endif
            @if(auth()->user()->level == 'Anggota')
            @include('dashboard.sidebarAnggota')
            @endif
          </ul>

                    ...
                    <div class="hero-inner">
                        <div class="hero-copy">
                            ...
                            <div class="hero-cta">
                                ...
                                <a class="button button-primary" href="{{route('admin.admin.dashboard')}}">Dashboard</a>
                                @elseif(auth()->user()->level == 'Penulis')
                                <a class="button button-primary" href="{{route('penulis.penulis.dashboard')}}">Dashboard</a>
                                @elseif(auth()->user()->level == 'Anggota')
                                <a class="button button-primary" href="{{route('anggota.anggota.dashboard')}}">Dashboard</a>
                                @endif
                                @else
